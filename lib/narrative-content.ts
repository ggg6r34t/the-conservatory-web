...
export const MEMBERSHIP_TIERS = [
  {
    ...
    role: "Begin",
    description:
      "Local-first care, reminders, calendar, memorials—the full rhythm of tending, without urgency.",
  },
  {
    name: "The Steward",
    role: "Monthly",
  ...
  },
  {
    ...
    role: "Annual",
    description:
      "The same depth, held steadily—plus premium themes for those who live inside their collection.",
  },
] as const;
